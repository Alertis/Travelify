  ...
  return (
    <Background>
        ...
        <View style={styles.inputGroups}>
          <TextInput label="Onay Kodu" style={styles.input} selectionColor='#600EE6' underlineColor="transparent" mode="outlined"/>
          <TextInput label="Yeni Şifre" style={styles.input} selectionColor='#600EE6' underlineColor="transparent" mode="outlined"/>
        </View>
